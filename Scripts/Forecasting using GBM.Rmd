---
title: "Building a Forecasting Model using GBM"
...
Once the data has been cleaned, we started prepping the data for modeling. We had to make sure there was no skip in dates and to do that we made a dates data frame to map to the cleaned data.
